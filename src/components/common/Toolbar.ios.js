            ...
            <View style={css.toolbarMenu}>
                ...
                <View style={{flexDirection:'row',alignItems:'center'}}>
                    ...
                    {self.props.gridButton ?
                        <IconImage action={Actions.productListLarge} image={require('../../images/icon-list.png')}/> : null }
                    ...
                    {self.props.searchButton ? <IconImage action={Actions.filter} image={require('../../images/icon-search.png')}/> : null }
                </View>
            </View>
        );
    }
